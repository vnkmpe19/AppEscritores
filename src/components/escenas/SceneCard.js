    ...
    <div className={`min-w-[180px] max-w-[220px] bg-white rounded-[32px] shadow-xl border-2 transition-all 
      ...
      <div className="p-5">
        <div className="flex items-center justify-between mb-3">
          <div className="flex items-center gap-2 text-[#BFD7ED]">
            <FileText size={14} />
          ...
          <div className="relative group/menu nodrag nopan"> 
            ...
            <div className="absolute right-0 top-full mt-1 hidden group-hover/menu:block bg-white shadow-2xl rounded-2xl border border-slate-50 py-2 z-[100] min-w-[100px] animate-in fade-in zoom-in duration-150">
              <button 
                onClick={(e) => { 
                  e.stopPropagation(); 
              ...
              >
                <Edit3 size={12} className="text-blue-500" /> Abrir Editor
              </button>
            </div>
          </div>
        </div>

        <h4 className="text-sm font-black text-slate-800 leading-tight mb-2 line-clamp-2">{data.label}</h4>
